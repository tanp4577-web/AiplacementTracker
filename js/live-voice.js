/* ============================================================================
   Live AI Engine
   Powers the PrepAI chatbot fallback and the offline resume analyzer:
    - Pollinations.ai free, keyless text AI when the /api/chat route is unavailable
    - Smart local fallbacks so answers still appear without any network
   (The old camera / microphone / speech modules were removed: no screen used them.)
   ========================================================================== */
const LiveAI = {
