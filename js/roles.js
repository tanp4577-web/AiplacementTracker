...
const ICONS = {
  ...
  _domains: {
    ...
    'logo-tcs': 'tcs.com',
    'logo-infosys': 'infosys.com',
    'logo-wipro': 'wipro.com',
    'logo-meta': 'meta.com',
    'logo-cognizant': 'cognizant.com',
    'logo-accenture': 'accenture.com'
  },
  _patterns: {
  ...
  logo(key) {
    ...
    if (domain) {
      return `<img src="https://logo.clearbit.com/${domain}?size=80" alt="${l.label}" loading="lazy"
        style="width:38px;height:38px;flex-shrink:0;border-radius:8px;object-fit:contain;background:#fff;border:1px solid var(--border);padding:4px"
        onerror="this.outerHTML='<svg viewBox=&quot;0 0 24 24&quot; style=&quot;width:38px;height:38px;flex-shrink:0&quot;><circle cx=&quot;12&quot; cy=&quot;12&quot; r=&quot;11&quot; fill=&quot;${l.color}&quot;/><text x=&quot;12&quot; y=&quot;15.5&quot; text-anchor=&quot;middle&quot; font-size=&quot;${l.label.length > 1 ? 6 : 9}&quot; font-weight=&quot;bold&quot; fill=&quot;%23241705&quot; font-family=&quot;Arial, sans-serif&quot;>${l.label}</text></svg>'" />`;
    }
